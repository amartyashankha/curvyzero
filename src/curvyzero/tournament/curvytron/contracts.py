...
from curvyzero.contracts.curvytron import (
    ...
    CURVYTRON_TOURNAMENT_GIF_FPS,
    CURVYTRON_TOURNAMENT_GIF_MIN_FRAME_DURATION_MS,
...
DEFAULT_DECISION_SOURCE_FRAMES = int(CURVYTRON_DECISION_SOURCE_FRAMES)
...
DEFAULT_GIF_FPS = CURVYTRON_TOURNAMENT_GIF_FPS
DEFAULT_GIF_MIN_FRAME_DURATION_MS = CURVYTRON_TOURNAMENT_GIF_MIN_FRAME_DURATION_MS
...
DEFAULT_LIVE_INTAKE_PAIR_SELECTION = RATING_PAIR_SELECTION_ADAPTIVE_V0
DEFAULT_LIVE_INTAKE_PAIRS_PER_ROUND = 300
...
__all__ = [
    ...
    "DEFAULT_LIVE_INTAKE_PAIR_SELECTION",
    "DEFAULT_LIVE_INTAKE_PAIRS_PER_ROUND",
    "DEFAULT_MAX_STEPS",
