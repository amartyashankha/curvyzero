...
def _run_survival_episode(
    *,
    ...
    return {
        ...
        "decision_source_frames": last_info.get("decision_source_frames"),
        "source_physics_step_ms": last_info.get("source_physics_step_ms"),
...
def _row_from_result(job: dict[str, Any], result: dict[str, Any]) -> dict[str, Any]:
    ...
    row = {
        ...
        "decision_source_frames": episode.get("decision_source_frames"),
        "source_physics_step_ms": episode.get("source_physics_step_ms"),
